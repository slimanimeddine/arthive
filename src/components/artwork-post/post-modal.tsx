...
export function ArtworkPostModal() {
              ...
              <div className="flex flex-col sm:max-w-4xl mx-auto gap-y-5">
                ...
                <div>
                  <p>
                    ...
                    Nihil, inventore. Suscipit quisquam exercitationem totam.
                    Optio corrupti debitis, alias iusto rem amet ea?
                    Perspiciatis non deserunt blanditiis veniam fuga. Porro,
                    minima.
                  </p>
                </div>
